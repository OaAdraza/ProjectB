    ...
    public partial class Form19 : Form
    {
        ...
        private void Form19_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dgAssessmentDetail.DataSource = ds.Tables["ss"];
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            int id = int.Parse(dgAssessmentDetail.Rows[row].Cells[0].Value.ToString());

            SqlCommand command = new SqlCommand("delete from Assessment where Id = '" + id + "'", con);
